...
class UserController
{
     ...
     */
    public function createUser($username, $password_hash, $first_name, $last_name, $email)
    {
        $insert_stmt = $this->pdo->prepare("INSERT INTO user (username, password_hash, firstname, lastname, email) VALUES (:username, :password_hash, :firstname, :lastname, :email)");
        $insert_stmt->execute([
            'username' => $username,
